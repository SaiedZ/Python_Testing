...
class TestLogin:
    ...
    def test_login_works_with_correct_email(
        self, client, mocker, mocked_clubs, test_club
    ):
        """
        ...
        self._test_root_response_code_template(response,
                                               "/showSummary", "Welcome")

    def test_login_not_possible_with_wrong_email(
